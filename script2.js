...
annotateButtonai.addEventListener('click', function() {
    if (isAnnotationMode) {
        isAnnotationMode = false;
        annotateButtonai.textContent = 'Activer le mode d\'annotation';
    } else {
        isAnnotationMode = true;
        annotateButtonai.textContent = 'Désactiver le mode d\'annotation';
    }
});
